"""
Django settings for SCC_KSTU project.
...
# recaptcha settings
RECAPTCHA_PUBLIC_KEY = '6LdlArsUAAAAAJ9X2LewNGGuHzbWcSsGL-YTMPhH'
...
WSGI_APPLICATION = 'SCC_KSTU.wsgi.application'
